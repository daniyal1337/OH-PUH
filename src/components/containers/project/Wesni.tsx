                  ...
                  <div className="section__content-cta">
                        <div className="row gaper">
                          ...
                          <h3 className="title-anim">INFLUENCER COLLABORATION</h3>
                            ...
                            <p> Wesnic Clothing’s influencer marketing strategy focused on collaborating with key fashion and lifestyle influencers to spread the brand's message of quality and style:
